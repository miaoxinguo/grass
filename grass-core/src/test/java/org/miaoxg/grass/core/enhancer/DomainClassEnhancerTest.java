...
public class DomainClassEnhancerTest {
	...
	public void shouldAddMethodsToDomainClass() throws Exception {
		...
		assertNotNull(ctClass.getMethod("findById", "(Ljava/io/Serializable;)Lorg/mar/model/Model;"));
...
//		assertNotNull(ctClass.getMethod("first", "([Ljava/lang/Object;)Lorg/mar/model/Model;"));
